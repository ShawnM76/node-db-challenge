...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
      Relational Databases store related data in seperate tables and linking them through primary and foreigh keys. SQL is a language used to perform queries on relational databases because it is not a database management system.

- [ ] Why do tables need a `primary key`?
      Tables need to have a primary key so that it can tell the difference between each other. Also you need a primary key to have a foreign key

- [ ] What is the name given to a table column that references the primary key on another table.
      foreign key

- [ ] What do we need in order to have a _many to many_ relationship between two tables.
      I cant describe it but like the TK said as an example a book can have more than one author and an author can write more than one book.
